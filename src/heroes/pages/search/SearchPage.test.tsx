...
vi.mock('./ui/SerachControls', () => ({
  CustomJumbotron: () => <div data-testid="search-controls"></div>,
}))
...
describe('SearchPage', () => {
  ...
  test('should call serach action name parameter', () => {
  ...
  test('should call serach action strength parameter', () => {
  ...
  test('should call serach action name and strength parameter', () => {
